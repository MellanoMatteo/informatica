class FioccoDiNeve
{
  //proprieta della classe
   ...
   {
     this.dim = (int) (random(MAX_DIM_FIOCCHI)+MIN_DIM_FIOCCHI);    
     this.xFiocco = (int) random(width);
     this.altezza = 0;
     this.velocita = (int) random(MAX_VELOCITA) + MIN_VELOCITA;    //setto una velocita di caduta casuale di ogni fiocco
   }
}
